...
data class CourierCreatedEvent(val name: PersonName,
...
data class CourierOrderAssignedEvent(override val aggregateIdentifier: CourierOrderId,
                                     val courierID: CourierID,
                                     override val auditEntry: AuditEntry)
  : CourierOrderEvent(aggregateIdentifier, auditEntry)

data class CourierOrderCreatedEvent(override val aggregateIdentifier: CourierOrderId,
                                    override val auditEntry: AuditEntry)
  : CourierOrderEvent(aggregateIdentifier, auditEntry)

data class CourierOrderDeliveredEvent(override val aggregateIdentifier: CourierOrderId,
                                      override val auditEntry: AuditEntry)
  : CourierOrderEvent(aggregateIdentifier, auditEntry)

data class CourierOrderNotAssignedEvent(override val aggregateIdentifier: CourierOrderId,
                                        override val auditEntry: AuditEntry)
  : CourierOrderEvent(aggregateIdentifier, auditEntry)